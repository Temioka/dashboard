class VerificationDashboard {
    ...
    setupAnimationStyles() {
        ...
        animationStyles.textContent = `
            /* Анимации для дашборда верификации */
            @keyframes fadeInUp {
                from {
                    opacity: 0;
            ...
            .verif-tab-switching {
                animation: tabSwitch 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            ...
            .verif-table-row-animate {
                animation: tableRowSlide 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
                opacity: 0;
            }
        `;
    ...
    buildAnimatedChartConfig(chartType, chartData) {
        const baseConfig = {
            ...
            options: {
                ...
                animation: {
                    ...
                    animateRotate: true,
                    animateScale: true,
                    // Добавляем кастомные анимации для разных типов графиков
                    ...(chartType === 'bar' && {
                        y: {
                            duration: this.config.animation.duration,
        ...
        // Добавляем настройки осей для не-круговых графиков
