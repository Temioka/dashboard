...
router.get('/api/call-center/stats', async (req, res) => {
    ...
    try {
        ...
        WHERE 
            ...
            AND (scd.proekt = 'Горячая линия' OR scd.proekt = 'Служба аварийных комиссаров')
        GROUP BY 
        ...
        // ИСПРАВЛЕНО: Запрос для данных того же дня на прошлой неделе с ПОЛНЫМИ данными AHT
